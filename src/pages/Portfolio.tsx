            ...
            {filteredProjects.map((project) => (
              ...
              >
                <Link
                  ...
                  className="h-full group relative flex flex-col gap-4 rounded-xl bg-white dark:bg-slate-800 p-0 shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-lg hover:border-primary/30 transition-all duration-300 overflow-hidden"
                >
